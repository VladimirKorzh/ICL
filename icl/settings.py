...
WSGI_APPLICATION = 'icl.wsgi.application'
...
####################################################################
# used in matchmaking
# to authentificate users using their steamOpenID
STEAM_API_KEY = '121A1CB1B99D9FA5C69DA2377E8B407F'
...
# forces the user to login each time
